...
## 1. 环境与数据准备
- [x] 1.1 下载 CamVid 数据集
- [x] 1.2 下载 CIFAR-10 数据集
- [x] 1.3 创建项目目录结构（code/, experiments/, report/, devlog/）
- [x] 1.4 验证 GPU 环境可用（torch.cuda.is_available）
...
## 4. ResNet 论文复现（组员C主责）
- [x] 4.1 实现 Plain-20/56 网络
- [x] 4.2 实现 ResNet-20/56 网络
- [x] 4.3 实现 CIFAR-10 训练脚本
- [x] 4.4 训练四组实验：Plain-20, Plain-56, ResNet-20, ResNet-56
- [x] 4.5 记录训练日志（loss, accuracy per epoch）
- [x] 4.6 绘制 train loss 对比曲线
- [x] 4.7 绘制 test accuracy 对比曲线
- [x] 4.8 分析 degradation 现象并撰写解释
